...
$name = $_POST['names'];
$sele = "SELECT * FROM result1 WHERE win1 LIKE '%$name%' or win2 LIKE '%$name%' or win3 LIKE '%$name%'";
...
<h1 class="liketext">Sports Fever</h1>
</header>
...
<nav>
		...
		<ul>
			...
			<li><a href="Results_stud.php" >Results</a></li><li><a href="search.html" style="color:red;">Search</a></li>
...
<footer>
  <p>If something stands between you and your success, move it..!</p>
</footer>
